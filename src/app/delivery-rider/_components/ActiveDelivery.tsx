          ...
          <div className="p-6 md:p-8 ">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <motion.button
                ...
                onClick={async () => {
                  await fetch(
                    `/api/delivery/assignments/${delivery._id}/deliver`,
                    {
                      method: "POST",
                    }
                  );
                }}
                className="bg-linear-to-r from-emerald-500 to-emerald-600 text-white py-3.5 rounded-xl font-bold hover:shadow-lg hover:shadow-emerald-500/50 transition-all flex items-center justify-center gap-2 cursor-pointer"
              >
