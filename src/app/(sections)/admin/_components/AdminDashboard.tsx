...
const AdminDashboard = () => {
  ...
  if (isPending) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-gray-50 via-white to-rose-50/20">
  ...
  return (
    <div className="min-h-screen mt-24 bg-linear-to-br from-gray-50 via-white to-rose-50/20">
